...
if __name__ == '__main__':
    ...
    wandb.init(project="syn_model_spectral")
    # wandb.init(project="syn_model_spectral", mode="disabled")
    ...
    model = models.spectralGP_model.SpectralMixtureGPModel(X_train, y_train, likelihood, config.mixtures, config.num_dims)
